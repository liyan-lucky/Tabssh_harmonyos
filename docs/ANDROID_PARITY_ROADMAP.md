...
4. 补齐工具箱剩余真实工具能力，优先使用纯 HarmonyOS API 继续完善上传测速、特权 ICMP 等价能力说明、二维码图片矩阵、更多网卡字段和复杂 Nginx include/变量展开；只有 HarmonyOS API 无法实现时才考虑三方库。
