...
- `.github/workflows/online-build.yml` 已作为线上构建入口：push/PR 跑静态审计，手动触发可在 `tabssh-deveco` 自托管 DevEco runner 上构建 Mock unsigned HAP 或 Real unsigned HAP 并上传 artifact。
