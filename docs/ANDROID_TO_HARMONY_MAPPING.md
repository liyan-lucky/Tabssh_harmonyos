...
| 连接管理 | RDB、分组、收藏、搜索、8 种排序、统计、日志、批量编辑 | groupId、favorite、sortOrder、lastConnectedAt、connectionCount、lastErrorMessage、remarks 字段骨架；内存仓库仍非 RDB，UI/统计未完成 |
...
这些只是模型兼容层。字段未接 UI、Native、RDB 和真实验收前，不能把对应 Android 功能标记为完成。
