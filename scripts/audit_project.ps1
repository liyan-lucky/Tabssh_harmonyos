...
$checks += @(
  ...
  [PSCustomObject]@{ Name = "toolbox-qr-svg-export"; Pass = $toolboxPage.Contains("buildQrSvg") -and $toolboxPage.Contains("exportQrSvg") -and $toolboxPage.Contains("DocumentSaveOptions") -and $toolboxPage.Contains("verifySavedText") -and $toolboxPage.Contains("QrPreview") -and $i18n.Contains("toolbox.qrSaveSvg") },
  [PSCustomObject]@{ Name = "toolbox-qr-svg-writeback"; Pass = $toolboxPage.Contains("fs.writeSync(destination.fd, this.qrSvgText)") -and $toolboxPage.Contains("this.toolOutput = this.toolOutput + '\n' + this.t('toolbox.qrSvgSaved')") -and $toolboxPage.Contains("this.toolOutput = this.toolOutput + '\n' + this.t('toolbox.qrSvgVerifyFailed')") },
  ...
  [PSCustomObject]@{ Name = "toolbox-nginx-include-import"; Pass = $toolboxPage.Contains("importNginxIncludeFile") -and $toolboxPage.Contains("readSelectedText('nginx-include')") -and $toolboxPage.Contains("DocumentSelectOptions") -and $toolboxPage.Contains("nginxAnalysisInput") -and $i18n.Contains("toolbox.nginxImportInclude") },
  ...
  [PSCustomObject]@{ Name = "toolbox-all-networks"; Pass = $toolboxPage.Contains("getAllNets") -and $toolboxPage.Contains("getNetCapabilities") -and $toolboxPage.Contains("formatBearerTypes") -and $toolboxPage.Contains("formatNetworkCaps") -and $i18n.Contains("toolbox.multiNetNote") },
