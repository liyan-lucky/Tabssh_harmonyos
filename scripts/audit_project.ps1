...
$checks += @(
  ...
  [PSCustomObject]@{ Name = "toolbox-network-utilities"; Pass = $toolboxPage.Contains("@ohos.net.socket") -and $toolboxPage.Contains("@ohos.net.connection") -and $toolboxPage.Contains("@ohos.net.http") -and $toolboxPage.Contains("runPortScan") -and $toolboxPage.Contains("runConnectivityTest") -and $toolboxPage.Contains("runSpeedTest") -and $toolboxPage.Contains("analyzeNginxConfig") -and $toolboxPage.Contains("replace(/\{/g, '{\n')") -and $toolboxPage.Contains("proxy_pass") },
  ...
  [PSCustomObject]@{ Name = "header-compact-spacing"; Pass = $indexPage.Contains("headerStatusInset") -and $indexPage.Contains("return Math.max(24, this.avoidStatusBarHeight - 18)") -and $indexPage.Contains("return this.headerStatusInset() + 48") -and $indexPage.Contains("return Math.max(32, this.headerOverlayHeight() - 40)") -and $indexPage.Contains(".height(46)") -and $indexPage.Contains(".height(40)") },
