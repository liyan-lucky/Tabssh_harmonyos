...
$checks += @(
  ...
  [PSCustomObject]@{ Name = "header-compact-spacing"; Pass = $indexPage.Contains("headerStatusInset") -and $indexPage.Contains("return Math.max(0, this.avoidStatusBarHeight - 10)") -and $indexPage.Contains("return this.headerStatusInset() + 64") -and $indexPage.Contains("return this.headerOverlayHeight() - 12") -and $indexPage.Contains(".height(52)") -and $indexPage.Contains(".height(48)") },
