...
$checks += @(
  ...
  [PSCustomObject]@{ Name = "toolbox-network-utilities"; Pass = $toolboxPage.Contains("@ohos.net.socket") -and $toolboxPage.Contains("@ohos.net.connection") -and $toolboxPage.Contains("@ohos.net.http") -and $toolboxPage.Contains("runPortScan") -and $toolboxPage.Contains("runConnectivityTest") -and $toolboxPage.Contains("runSpeedTest") -and $toolboxPage.Contains("analyzeNginxConfig") },
  ...
  [PSCustomObject]@{ Name = "header-compact-spacing"; Pass = $indexPage.Contains("headerStatusInset") -and $indexPage.Contains("return Math.max(0, this.avoidStatusBarHeight - 18)") -and $indexPage.Contains("return this.headerStatusInset() + 56") -and $indexPage.Contains("return this.headerOverlayHeight() - 20") -and $indexPage.Contains(".height(50)") -and $indexPage.Contains(".height(44)") },
