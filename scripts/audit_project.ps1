...
$checks += @(
  ...
  [PSCustomObject]@{ Name = "header-compact-spacing"; Pass = $indexPage.Contains("return this.avoidStatusBarHeight + 76") -and $indexPage.Contains("return this.headerOverlayHeight() - 14") -and $indexPage.Contains(".height(56)") -and $indexPage.Contains(".height(52)") },
